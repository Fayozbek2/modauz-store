      ...
      <header>
          ...
          <div className="top-bar">
            <div className="content-topbar flex-sb-m h-full container">
              ...
              <div className="right-top-bar flex-w h-full">
                <a href="#" className="flex-c-m trans-04 p-lr-25">Help & FAQs</a>
                <a href="#" className="flex-c-m trans-04 p-lr-25">My Account</a>
            ...
            <nav className="limiter-menu-desktop container">
              ...
              <div className="menu-desktop">
                <ul className="main-menu">
                  ...
                  <li className="label1" data-label1="hot"><a href="/shoping-cart">Features</a></li>
        ...
        <div className="menu-mobile">
          ...
          <ul className="main-menu-m">
            ...
            <li><a href="/product">Shop</a></li>
            <li>
              <a href="/shoping-cart" className="label1 rs1" data-label1="hot">
                Features
              </a>
            </li>
            <li><a href="/blog">Blog</a></li>
